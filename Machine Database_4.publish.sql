...
GO
/*
The column [dbo].[General_Table].[FileLocation1] is being dropped, data loss could occur.

The column [dbo].[General_Table].[FileLocation2] is being dropped, data loss could occur.
*/
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_General_Table] ([Id], [Machine_Type], [Year_Built], [Original_Owner], [Date_Acquired], [Description], [Image], [Maintenence_Information], [Model], [Machine_Location], [Restoration_Status], [Link_to_TractorData], [Donated_Or_Loaned], [Make], [SecondImage], [Other_Notes], [IfSold])
        SELECT   [Id],
                 [Machine_Type],
                 [Year_Built],
                 [Original_Owner],
