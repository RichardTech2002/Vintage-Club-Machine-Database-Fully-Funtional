...
namespace User_Interface_For_Vintage_Club_Database
{
    ...
    {
        public string ImageLocation1 = @"E:\Database General Folder\No Image Icon.jpg";
        public string ImageLocation2 = @"E:\Database General Folder\No Image Icon.jpg";
        public string ImageLocation3 = @"E:\Database General Folder\No Image Icon.jpg";
        ...
        public void BoxChecker()
        {
            ...
            if (pictureBox3.ImageLocation == @"E:\Database General Folder\No Image Icon.jpg")
            {
                MessageBoxDisplay.Text = "Yes";
                Duh++;
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (Duh < 15)
            {
                ...
                if (DoubleCheck == DialogResult.OK)
                {
                    ...
                    SqlCommand insertcommand = new SqlCommand("insert into General_Table(Machine_Type, Year_Built, Original_Owner, Date_Acquired, Description, Machine_Location, Restoration_Status, Donated_Or_Loaned, Link_To_TractorData, Model, Make, Other_Notes, IfSold, FileLocation1, FileLocation2, FileLocation3) Values (@Machinetype, @YearBuilt, @OriginalOwner, @DateAcquired, @Description, @MachineLocation, @RestorationStatus, @DonatedOrLoaned, @LinkToTractorData, @Model, @Make, @Other_Notes, @IfSold, @FileLocation1, @FileLocation2, @FileLocation3)");
                    ...
                    insertcommand.Parameters.AddWithValue(@"FileLocation3", ImageLocation3);
